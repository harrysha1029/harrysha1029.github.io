...
var $author$project$Icons$facebook = A2(
...
var $author$project$Icons$linkedin = A2(
	$author$project$Icons$svgFeatherIcon,
	'linkedin',
	_List_fromArray(
		[
...
var $author$project$Icons$youtube = A2(
	$author$project$Icons$svgFeatherIcon,
	'youtube',
	_List_fromArray(
		[
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/harrysha1029')
						]),
					_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://www.youtube.com/channel/UCVjPFH1nsdSB03heP0Al36A?view_as=subscriber')
						]),
					_List_fromArray(
						[$author$project$Icons$youtube]))
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://www.linkedin.com/in/harry-sha-374345145/')
						]),
					_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://www.facebook.com/harry.sha.12')
						]),
					_List_fromArray(
						[$author$project$Icons$facebook]))
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('/cv')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('/fun')
									]),
								_List_fromArray(
									[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$color($author$project$Styles$black),
